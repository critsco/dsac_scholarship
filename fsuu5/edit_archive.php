...
<head>
    ...
    <title>Edit Archive Scholarship Information</title>
...
<body>
    <h1>Edit Archive Scholarship Information Form</h1>
    ...
    <script>
        function cancelEdit() {
            // Redirect back to archive.php when the cancel button is clicked
