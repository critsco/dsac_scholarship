...
<head>
    ...
    <title>Edit Draft Scholarship Information</title>
...
<body>
    <h1>Edit Draft Scholarship Information Form</h1>
    ...
    <script>
        function cancelEdit() {
            // Redirect back to draft2.php when the cancel button is clicked
            window.location.href = 'draft2.php';
        }
    </script>
</body>
</html>
