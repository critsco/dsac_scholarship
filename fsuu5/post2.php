...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['archive_button'])) {
        ...
        $sql_update_status = "UPDATE scholarship SET status = 'Archive' WHERE id = $scholarship_id";
...
<body class="bg-light">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto active" href="post2.php">Post</a>
  ...
  <main id="main">
    ...
    <div class="text-center mb-4">
        <a href="post2.html" class="btn btn-primary">Post Scholarship</a>
    </div>
...
while ($row_post = $result_post->fetch_assoc()) {
    echo "<tr>
            ...
            <td class='text-center'>
                <form action='edit_scholarship2.php' method='get' style='display:inline;'>
                    <input type='hidden' name='id' value='" . $row_post['id'] . "'>
                    <button type='submit' class='btn btn-warning'>Edit</button>
                </form> <br> <br>
                <form method='post' style='display:inline;'>
                    <input type='hidden' name='id' value='" . $row_post['id'] . "'>
                    <button type='submit' name='archive_button' class='btn btn-secondary'>Archive</button>
                </form> <br> <br>
                <form action='delete_scholarship2.php' method='get' style='display:inline; margin-left: 5px;'>
                    <input type='hidden' name='id' value='" . $row_post['id'] . "'>
