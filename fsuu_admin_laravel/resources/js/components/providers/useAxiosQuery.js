...
export function POST(url, key_name, isLoading = true, onSuccessFunction) {
...
export function POSTFILE(url, key_name, isLoading = true, onSuccessFunction) {
    const queryClient = useQueryClient();
...
export function UPDATE(url, key_name, isLoading = true, onSuccessFunction) {
    const queryClient = useQueryClient();
...
export function DELETE(url, key_name, isLoading = true, onSuccessFunction) {
    const queryClient = useQueryClient();
